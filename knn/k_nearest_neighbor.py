...
class KNearestNeighbor:
    ...
    def predict_labels(self, dists, k=1):
        ...
        for i in range(num_test):
            ...
            cnt = np.bincount(
                closest_y
            )  # np.bincount вернет массив, где индекс — это метка, а значение — кол-во голосов
            y_pred[i] = np.argmax(cnt)  # Если максимумов несколько, он вернет ПЕРВЫЙ из них (наименьшую метку).
            # *****END OF YOUR CODE (DO NOT DELETE/MODIFY THIS LINE)*****
